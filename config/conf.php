...
*/
		...
		switch ($CHR->PD->page) {
			case 1:
				//include_once ('/functions/navody.php');
			...
			case 15:
				include_once ('./functions/user-profil.php');
			...
			case 16:	//ITEM PROFILE
				include_once ('./functions/media.php');
				include_once ('./functions/items.php');
				include_once ('./functions/item-profil.php');
				
				if ( $IP->IP->public != 1 )
					header( "Location: ".$GD->link(1) );

				$TAGSS = $IP->generate_tags();
